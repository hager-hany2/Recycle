...
class OrderPointFormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'OrderPoint_id' =>'required|exists:products,product_id',
    ...
    public function attributes(){
        return[
            ...
            'ProductPoint_id'=>__('keywords.ProductPoint_id'),
    ...
    public function messages()
    {
        return[
            ...
            'ProductPoint_id.required'=>__('keywords.error_msg_ProductPoint_id'),//يضع الرساله في حاله ظهور ايرور ونحطها في(keyword  ar en)
